...
VARIABLE_NAMES="IOS_BUNDLE_ID IOS_SCHEME ANDROID_PACKAGE XCODE_VERSION IOS_SIGNING_ENABLED ANDROID_SIGNING_ENABLED STORE_UPLOADS_ENABLED STORE_METADATA_SYNC_ENABLED HUAWEI_APP_ID HUAWEI_UPLOADS_ENABLED HUAWEI_SUBMIT_DELAY_SECONDS HUAWEI_FEEDBACK_EMAIL HUAWEI_TEST_DAYS IOS_METADATA_EDIT_LIVE PLAY_METADATA_TRACK BUILD_NUMBER_OFFSET WORKFLOWS_MACOS_RUNNER TESTFLIGHT_INTERNAL_GROUP TESTFLIGHT_EXTERNAL_GROUP PLAY_UPDATE_PRIORITY ANDROID_UPLOAD_CERT_SHA256 OTA_ENABLED EXPO_UPDATES_URL OTA_CLI_VERSION STORE_NOTES_INCLUDE_CHANGELOG RELEASE_NOTES_LLM_PROVIDER RELEASE_NOTES_LLM_MODEL RELEASE_NOTES_LLM_EFFORT RELEASE_NOTES_LLM_EXTRA_PARAMS OPENAI_BASE_URL EXPO_PUBLIC_API_URL EXPO_PUBLIC_APP_NAME EXPO_PUBLIC_WEB_DOMAIN EXPO_PUBLIC_ALLOW_INSECURE_WEB_STORAGE E2E_IOS"
